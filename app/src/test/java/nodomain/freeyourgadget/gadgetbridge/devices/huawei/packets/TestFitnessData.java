...
public class TestFitnessData {
    ...
    public void testMessageCountRequest() throws NoSuchFieldException, IllegalAccessException {
        ...
        HuaweiTLV expectedTlvSleep = new HuaweiTLV()
                ...
                .put(0x03, startSleep)
                .put(0x04, endSleep);
        expectedTlvSleep.encrypt(secretsProvider.getSecretKey(), secretsProvider.getIv());
        HuaweiTLV expectedTlvStep = new HuaweiTLV()
                .put(0x81)
                .put(0x03, startStep)
                .put(0x04, endStep);
        expectedTlvStep.encrypt(secretsProvider.getSecretKey(), secretsProvider.getIv());
        ...
        Assert.assertArrayEquals(sleepSerialized, sleepRequest.serialize());
        ...
        Assert.assertArrayEquals(stepSerialized, stepRequest.serialize());
    }
    ...
    public void testMessageDataRequest() throws NoSuchFieldException, IllegalAccessException {
        ...
        Assert.assertTrue(sleepRequest.complete);
        Assert.assertArrayEquals(expectedSleep, sleepRequest.serialize());

        Assert.assertEquals(0x07, stepRequest.serviceId);
        Assert.assertEquals(0x0b, stepRequest.commandId);
        Assert.assertEquals(expectedTlv, tlvField.get(stepRequest));
        Assert.assertTrue(stepRequest.complete);
        Assert.assertArrayEquals(expectedStep, stepRequest.serialize());
    }
    ...
    public void testActivityReminderRequest() throws NoSuchFieldException, IllegalAccessException {
        ...
        Assert.assertArrayEquals(expected, request.serialize());
    }
