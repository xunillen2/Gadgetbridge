...
public class GetSupportedCommandsRequest extends Request {
    ...
    public GetSupportedCommandsRequest(HuaweiLESupport support) {
        super(support);
    ...
    public GetSupportedCommandsRequest(HuaweiLESupport support, ArrayList<HuaweiPacket> commandsRequests) {
        super(support);
        this.serviceId = DeviceConfig.id;
        this.commandId = DeviceConfig.SupportedCommands.id;
