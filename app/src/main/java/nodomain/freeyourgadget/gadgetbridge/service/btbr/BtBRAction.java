...
public abstract class BtBRAction {
    protected final BluetoothSocketCharacteristic characteristic;
    private final long creationTimestamp;

    public BtBRAction(BluetoothSocketCharacteristic characteristic) {
    ...
    /**
     * Returns the Socket characteristic being read/written/...
     *
     * @return the Socket characteristic, or <code>null</code>
     */
    public BluetoothSocketCharacteristic getCharacteristic() {
    ...
    public String toString() {
        //BluetoothSocketCharacteristic characteristic = getCharacteristic();
