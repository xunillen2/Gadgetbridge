...
import nodomain.freeyourgadget.gadgetbridge.service.devices.huawei.requestsLE.SetMusicStatusRequest;
 ...
 *
 */
public class AsynchronousResponseLE {
    private static final Logger LOG = LoggerFactory.getLogger(AsynchronousResponseLE.class);
    ...
    public AsynchronousResponseLE(HuaweiLESupport support) {
