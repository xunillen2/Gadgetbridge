...
public class GetSupportedCommandsRequest extends Request {
    ...
    public GetSupportedCommandsRequest(HuaweiBRSupport support) {
        super(support);
    ...
    public GetSupportedCommandsRequest(HuaweiBRSupport support, ArrayList<HuaweiPacket> commandsRequests) {
        super(support);
        this.serviceId = DeviceConfig.id;
        this.commandId = DeviceConfig.SupportedCommands.id;
