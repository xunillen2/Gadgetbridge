...
import nodomain.freeyourgadget.gadgetbridge.service.devices.huawei.requestsBR.SetMusicStatusRequest;
 ...
 *
 */
public class AsynchronousResponseBR {
    private static final Logger LOG = LoggerFactory.getLogger(AsynchronousResponseBR.class);
    ...
    public AsynchronousResponseBR(HuaweiBRSupport support) {
