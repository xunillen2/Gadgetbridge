...
public class GetWorkoutTotalsRequest extends Request {
     ...
     */
    public GetWorkoutTotalsRequest(HuaweiBRSupport support, Workout.WorkoutCount.Response.WorkoutNumbers workoutNumbers, List<Workout.WorkoutCount.Response.WorkoutNumbers> remainder) {
        super(support);
